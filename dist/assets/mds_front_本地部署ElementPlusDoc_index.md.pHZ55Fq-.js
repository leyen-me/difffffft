import{_ as n,c as s,o as e,R as a}from"./chunks/framework.43nt70q0.js";const h=JSON.parse('{"title":"用Docker部署Element-Plus文档","description":"","frontmatter":{"title":"用Docker部署Element-Plus文档","date":"2023-03-28","categories":["前端"]},"headers":[],"relativePath":"mds/front/本地部署ElementPlusDoc/index.md","filePath":"mds/front/本地部署ElementPlusDoc/index.md","lastUpdated":null}'),p={name:"mds/front/本地部署ElementPlusDoc/index.md"},l=a(`<p>用Docker部署Element-Plus文档</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>mkdir -p /root/element-plus-doc/conf</span></span>
