import{_ as n,c as s,o as e,U as a}from"./chunks/framework.hWf9kaa6.js";const h=JSON.parse('{"title":"用Docker部署Element-Plus文档","description":"","frontmatter":{"title":"用Docker部署Element-Plus文档","date":"2023-03-28","categories":["前端"]},"headers":[],"relativePath":"mds/front/Vue/本地部署ElementPlusDoc/index.md","filePath":"mds/front/Vue/本地部署ElementPlusDoc/index.md","lastUpdated":1704782344000}'),p={name:"mds/front/Vue/本地部署ElementPlusDoc/index.md"},l=a(`<p>用Docker部署Element-Plus文档</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>mkdir -p /root/element-plus-doc/conf</span></span>
...
<span class="line"><span>systemctl restart firewalld</span></span></code></pre></div>`,4),t=[l];function c(o,i,d,r,m,u){return e(),s("div",null,t)}const f=n(p,[["render",c]]);export{h as __pageData,f as default};
