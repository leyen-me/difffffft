import{_ as s,c as n,o as a,R as p}from"./chunks/framework.43nt70q0.js";const m=JSON.parse('{"title":"Vue如何一行代码显示业务级弹窗","description":"","frontmatter":{"title":"Vue如何一行代码显示业务级弹窗","date":"2023-11-29","categories":["前端"]},"headers":[],"relativePath":"mds/front/2023-11-29-vue如何一行代码显示弹窗/index.md","filePath":"mds/front/2023-11-29-vue如何一行代码显示弹窗/index.md","lastUpdated":1704444471000}'),t={name:"mds/front/2023-11-29-vue如何一行代码显示弹窗/index.md"},l=p(`<p>在前端中处理业务级别的弹窗问题是非常麻烦的事情，调用的次数很多，代码也很多很混乱。</p><p>下面将介绍如何用Vue的Jsx的能力实现一行代码控制业务弹窗的显示，关闭，回调。</p><p>如果要在Vue中要使用Jsx</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npm i @vitejs/plugin-vue-jsx -D</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import vueJsx from &quot;@vitejs/plugin-vue-jsx&quot;; // 配置vue使用jsx</span></span>
...
<span class="line"><span>  onReject</span></span>
<span class="line"><span>})</span></span>
<span class="line"><span>showDialog()</span></span></code></pre></div><p>所以说由此可见，在React，天生处理弹窗的能力就非常强</p><p>Vue结合Jsx也非常强。但是Jsx学习成本问题，处理v-model的问题。这种方式更适合React和Vue都会的。</p>`,12),e=[l];function i(c,o,d,u,g,r){return a(),n("div",null,e)}const v=s(t,[["render",i]]);export{m as __pageData,v as default};
