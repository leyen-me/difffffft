import{_ as s,o as n,c as a,R as e}from"./chunks/framework.lUyD4Cud.js";const m=JSON.parse('{"title":"Chromium","description":"","frontmatter":{"title":"Chromium","date":"2023-07-01","categories":["前端"]},"headers":[],"relativePath":"mds/front/2023-07-01-chromium/index.md","filePath":"mds/front/2023-07-01-chromium/index.md","lastUpdated":1704444471000}'),t={name:"mds/front/2023-07-01-chromium/index.md"},p=e(`<p>记录一下<a href="https://github.com/difffffft/chromium" target="_blank" rel="noreferrer">chromium</a>内核编译的流程</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1.windows官方构建流程</span></span>
...
<span class="line"><span>autoninja -C out\\Default chrome</span></span></code></pre></div>`,26),l=[p];function i(o,c,r,d,u,h){return n(),a("div",null,l)}const b=s(t,[["render",i]]);export{m as __pageData,b as default};
