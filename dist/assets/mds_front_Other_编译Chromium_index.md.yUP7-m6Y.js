import{_ as s,c as n,o as a,U as e}from"./chunks/framework.hWf9kaa6.js";const m=JSON.parse('{"title":"Chromium","description":"","frontmatter":{"title":"Chromium","date":"2023-07-01","categories":["前端"]},"headers":[],"relativePath":"mds/front/Other/编译Chromium/index.md","filePath":"mds/front/Other/编译Chromium/index.md","lastUpdated":null}'),t={name:"mds/front/Other/编译Chromium/index.md"},p=e(`<p>记录一下<a href="https://github.com/difffffft/chromium" target="_blank" rel="noreferrer">chromium</a>内核编译的流程</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1.windows官方构建流程</span></span>
