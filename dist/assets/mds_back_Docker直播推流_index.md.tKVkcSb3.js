import{_ as s,c as a,o as n,R as p}from"./chunks/framework.43nt70q0.js";const u=JSON.parse('{"title":"Docker创建直播推流服务器","description":"","frontmatter":{"title":"Docker创建直播推流服务器","date":"2023-04-24","categories":["后端"]},"headers":[],"relativePath":"mds/back/Docker直播推流/index.md","filePath":"mds/back/Docker直播推流/index.md","lastUpdated":null}'),e={name:"mds/back/Docker直播推流/index.md"},l=p(`<p>1.<strong>创建 bridge 网络并指定 IP 区间</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#创建自定义网络</span></span>
...
<span class="line"><span>http://服务器 IP 地址:8080</span></span></code></pre></div>`,10),t=[l];function c(o,i,r,d,h,g){return n(),a("div",null,t)}const v=s(e,[["render",c]]);export{u as __pageData,v as default};
