import{_ as n,c as s,o as a,R as p}from"./chunks/framework.43nt70q0.js";const x=JSON.parse('{"title":"ElementPlus表格列合并","description":"","frontmatter":{"title":"ElementPlus表格列合并","date":"2023-08-10","categories":["前端"]},"headers":[],"relativePath":"mds/front/ElementPlus表格列合并/index.md","filePath":"mds/front/ElementPlus表格列合并/index.md","lastUpdated":null}'),e={name:"mds/front/ElementPlus表格列合并/index.md"},l=p(`<p>对特定的列，值相同的列进行合并处理</p><p>前提：排序之后使用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const arraySpanMethod = (tableData) =&gt; {</span></span>
