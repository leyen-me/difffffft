import{_ as a,c as s,o as n,R as p}from"./chunks/framework.43nt70q0.js";const m=JSON.parse('{"title":"Java8+的新特性","description":"","frontmatter":{"title":"Java8+的新特性","date":"2023-08-21","categories":["后端"]},"headers":[],"relativePath":"mds/back/Java8的新特性/index.md","filePath":"mds/back/Java8的新特性/index.md","lastUpdated":null}'),e={name:"mds/back/Java8的新特性/index.md"},l=p(`<h2 id="_1-lambda表达式" tabindex="-1">1.<strong>Lambda表达式</strong> <a class="header-anchor" href="#_1-lambda表达式" aria-label="Permalink to &quot;1.**Lambda表达式**&quot;">​</a></h2><p>Lambda的本质是java中接口的一个实例（接口的实现类的具体对象）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>Thread thread= new Thread(() -&gt; System.out.println(&quot;Hello World&quot;));</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>jpackage --type app-image --input [Jar包所在文件夹] --runtime-image [Jre文件夹] --name [应用名称] --main-jar [可执行Jar包] --icon [程序图标的路径] --app-version [版本号] --vendor [程序供应商的名称] --copyright [版权信息] --description [应用描述] --dest [输出目录]</span></span></code></pre></div><p>启动windows功能.Net Framework 3.5.1</p><p><strong><em>安装wix</em></strong></p>`,55),t=[l];function i(c,o,r,u,d,g){return n(),s("div",null,t)}const b=a(e,[["render",i]]);export{m as __pageData,b as default};
