import{_ as s,c as n,o as a,R as p}from"./chunks/framework.43nt70q0.js";const e="/assets/image-1.bQyPP8bV.png",u=JSON.parse('{"title":"Tencent前端代码规范","description":"","frontmatter":{"title":"Tencent前端代码规范","date":"2023-11-29","categories":["前端"]},"headers":[],"relativePath":"mds/front/前端代码规范/index.md","filePath":"mds/front/前端代码规范/index.md","lastUpdated":null}'),l={name:"mds/front/前端代码规范/index.md"},i=p('<h2 id="项目结构" tabindex="-1">项目结构 <a class="header-anchor" href="#项目结构" aria-label="Permalink to &quot;项目结构&quot;">​</a></h2><p><img src="'+e+`" alt=""></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>--.git                 版本控制系统</span></span>
...
<span class="line"><span>--vite.config.ts       Vite配置文件</span></span></code></pre></div><p>目录规范和文件规范，请参考</p><p><a href="https://github.com/difffffft/tdesign-vue-next-starter" target="_blank" rel="noreferrer">difffffft/tdesign-vue-next-starter: A starter-kit for TDesign Vue Next UI components (github.com)</a></p>`,5),t=[i];function c(o,r,d,m,g,f){return a(),n("div",null,t)}const h=s(l,[["render",c]]);export{u as __pageData,h as default};
