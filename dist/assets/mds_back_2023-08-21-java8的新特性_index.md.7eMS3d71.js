import{_ as a,o as s,c as n,R as p}from"./chunks/framework.lUyD4Cud.js";const m=JSON.parse('{"title":"Java8+的新特性","description":"","frontmatter":{"title":"Java8+的新特性","date":"2023-08-21","categories":["后端"]},"headers":[],"relativePath":"mds/back/2023-08-21-java8的新特性/index.md","filePath":"mds/back/2023-08-21-java8的新特性/index.md","lastUpdated":1704444471000}'),e={name:"mds/back/2023-08-21-java8的新特性/index.md"},l=p(`<h2 id="_1-lambda表达式" tabindex="-1">1.<strong>Lambda表达式</strong> <a class="header-anchor" href="#_1-lambda表达式" aria-label="Permalink to &quot;1.**Lambda表达式**&quot;">​</a></h2><p>Lambda的本质是java中接口的一个实例（接口的实现类的具体对象）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>Thread thread= new Thread(() -&gt; System.out.println(&quot;Hello World&quot;));</span></span>
