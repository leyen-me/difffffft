...
<span class="line"><span>--vite.config.ts       Vite配置文件</span></span></code></pre></div><p>目录规范和文件规范，请参考</p><p><a href="https://github.com/difffffft/tdesign-vue-next-starter" target="_blank" rel="noreferrer">difffffft/tdesign-vue-next-starter: A starter-kit for TDesign Vue Next UI components (github.com)</a></p>`,5),t=[i];function c(o,r,d,m,g,f){return n(),a("div",null,t)}const h=s(l,[["render",c]]);export{u as __pageData,h as default};
