import{_ as n,c as s,o as a,R as p}from"./chunks/framework.43nt70q0.js";const x=JSON.parse('{"title":"ElementPlus表格列合并","description":"","frontmatter":{"title":"ElementPlus表格列合并","date":"2023-08-10","categories":["前端"]},"headers":[],"relativePath":"mds/front/2023-08-10-elementplus表格列合并/index.md","filePath":"mds/front/2023-08-10-elementplus表格列合并/index.md","lastUpdated":1704444471000}'),e={name:"mds/front/2023-08-10-elementplus表格列合并/index.md"},l=p(`<p>对特定的列，值相同的列进行合并处理</p><p>前提：排序之后使用</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>const arraySpanMethod = (tableData) =&gt; {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,3),t=[l];function c(o,i,r,d,u,_){return a(),s("div",null,t)}const f=n(e,[["render",c]]);export{x as __pageData,f as default};
